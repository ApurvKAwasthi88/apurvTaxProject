# The Tax Project It helps the client to compute taxes for various countries based on their Tax Rules and generates a recipt for items provided to the api
